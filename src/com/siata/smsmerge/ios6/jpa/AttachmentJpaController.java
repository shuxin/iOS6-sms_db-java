...
public class AttachmentJpaController implements Serializable {
    ...
    public void create(Attachment attachment) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Message messageListMessageToAttach : attachment.getMessageList()) {
                messageListMessageToAttach = em.getReference(messageListMessageToAttach.getClass(), messageListMessageToAttach.getRowid());
    ...
    public void edit(Attachment attachment) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Attachment persistentAttachment = em.find(Attachment.class, attachment.getRowid());
            List<Message> messageListOld = persistentAttachment.getMessageList();
            ...
            for (Message messageListNewMessageToAttach : messageListNew) {
                messageListNewMessageToAttach = em.getReference(messageListNewMessageToAttach.getClass(), messageListNewMessageToAttach.getRowid());
            ...
            for (Message messageListOldMessage : messageListOld) {
                if (!messageListNew.contains(messageListOldMessage)) {
                    messageListOldMessage.getAttachmentList().remove(attachment);
