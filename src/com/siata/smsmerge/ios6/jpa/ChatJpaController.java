...
public class ChatJpaController implements Serializable {
    ...
    public void create(Chat chat) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Handle handleListHandleToAttach : chat.getHandleList()) {
                handleListHandleToAttach = em.getReference(handleListHandleToAttach.getClass(), handleListHandleToAttach.getRowid());
            ...
            for (ChatMessageJoin chatMessageJoinListChatMessageJoinToAttach : chat.getChatMessageJoinList()) {
                chatMessageJoinListChatMessageJoinToAttach = em.getReference(chatMessageJoinListChatMessageJoinToAttach.getClass(), chatMessageJoinListChatMessageJoinToAttach.getMessageId());
                attachedChatMessageJoinList.add(chatMessageJoinListChatMessageJoinToAttach);
            }
            ...
            for (ChatMessageJoin chatMessageJoinListChatMessageJoin : chat.getChatMessageJoinList()) {
                Chat oldChatIdOfChatMessageJoinListChatMessageJoin = chatMessageJoinListChatMessageJoin.getChatId();
                chatMessageJoinListChatMessageJoin.setChatId(chat);
                chatMessageJoinListChatMessageJoin = em.merge(chatMessageJoinListChatMessageJoin);
                if (oldChatIdOfChatMessageJoinListChatMessageJoin != null) {
                    oldChatIdOfChatMessageJoinListChatMessageJoin.getChatMessageJoinList().remove(chatMessageJoinListChatMessageJoin);
                    oldChatIdOfChatMessageJoinListChatMessageJoin = em.merge(oldChatIdOfChatMessageJoinListChatMessageJoin);
                }
            }
    ...
    public void edit(Chat chat) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<ChatMessageJoin> chatMessageJoinListOld = persistentChat.getChatMessageJoinList();
            List<ChatMessageJoin> chatMessageJoinListNew = chat.getChatMessageJoinList();
            List<Handle> attachedHandleListNew = new ArrayList<Handle>();
            for (Handle handleListNewHandleToAttach : handleListNew) {
                handleListNewHandleToAttach = em.getReference(handleListNewHandleToAttach.getClass(), handleListNewHandleToAttach.getRowid());
            ...
            for (ChatMessageJoin chatMessageJoinListNewChatMessageJoinToAttach : chatMessageJoinListNew) {
                chatMessageJoinListNewChatMessageJoinToAttach = em.getReference(chatMessageJoinListNewChatMessageJoinToAttach.getClass(), chatMessageJoinListNewChatMessageJoinToAttach.getMessageId());
                attachedChatMessageJoinListNew.add(chatMessageJoinListNewChatMessageJoinToAttach);
            }
            ...
            for (ChatMessageJoin chatMessageJoinListOldChatMessageJoin : chatMessageJoinListOld) {
                if (!chatMessageJoinListNew.contains(chatMessageJoinListOldChatMessageJoin)) {
                    chatMessageJoinListOldChatMessageJoin.setChatId(null);
                    chatMessageJoinListOldChatMessageJoin = em.merge(chatMessageJoinListOldChatMessageJoin);
                }
            }
            for (ChatMessageJoin chatMessageJoinListNewChatMessageJoin : chatMessageJoinListNew) {
                if (!chatMessageJoinListOld.contains(chatMessageJoinListNewChatMessageJoin)) {
                    Chat oldChatIdOfChatMessageJoinListNewChatMessageJoin = chatMessageJoinListNewChatMessageJoin.getChatId();
                    chatMessageJoinListNewChatMessageJoin.setChatId(chat);
                    chatMessageJoinListNewChatMessageJoin = em.merge(chatMessageJoinListNewChatMessageJoin);
                    if (oldChatIdOfChatMessageJoinListNewChatMessageJoin != null && !oldChatIdOfChatMessageJoinListNewChatMessageJoin.equals(chat)) {
                        oldChatIdOfChatMessageJoinListNewChatMessageJoin.getChatMessageJoinList().remove(chatMessageJoinListNewChatMessageJoin);
                        oldChatIdOfChatMessageJoinListNewChatMessageJoin = em.merge(oldChatIdOfChatMessageJoinListNewChatMessageJoin);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            List<ChatMessageJoin> chatMessageJoinList = chat.getChatMessageJoinList();
